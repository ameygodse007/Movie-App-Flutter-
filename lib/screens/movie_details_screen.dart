...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    final routeArgs = ModalRoute.of(context)!.settings.arguments as Movie;
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          height: 65,
                          child: Tab(
                            icon: routeArgs.adult == true
                                ? Image.network(
                                    "https://img.icons8.com/color/452/18-plus.png")
                                : Image.network(
                                    "https://www.coastguardstudio.co.uk/wp-content/uploads/2020/06/no-under-18s-age-restriction-11552729874i1uo3lprzh.png"),
                          ),
                        )
                      ],
                    ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          routeArgs.releaseDate.toString(),
                          style: TextStyle(
          ...
          Expanded(
            child: RaisedButton(
              ...
              child: GestureDetector(
                onTap: () {
                  String a ;
                  apiservice.getVideo(id).then((String result) {
                    watchTralier(result ?? "");
                  });
